...
|---|---|---|---|---|
| `accident_bundle` | Accident bundle (heterogeneous evidence over one occurrence) | H1 | — | accident_licence_a, accident_licence_b, accident_photo_a, accident_photo_b, accident_photo_c, accident_statement_a, accident_statement_b |
...
| `accident_photo_c` | Accident bundle: photograph of vehicle B, image withheld | H1 | — | — |
